...
//        insertMockComments();
    ...
    private void insertMockAudiobookData() {
        ...
        List<Audiobook> audiobooks = Arrays.asList(
                ...
                new Audiobook(null, "The Scarlet Letter", "Nathaniel Hawthorne", "Set in 17th-century Puritan Massachusetts, 'The Scarlet Letter' explores the consequences of adultery through the life of Hester Prynne. The scarlet letter 'A' becomes a symbol of her sin, as secrets and guilt unravel in this classic tale.", null, null, Date.valueOf("1850-03-16"), new BigDecimal("4.0"), 2, 0, new HashSet<>(Collections.singletonList(categories.get(1)))),
                new Audiobook(null, "The Maltese Falcon", "Dashiell Hammett", "Sam Spade, a private detective, becomes entangled in a web of crime and deceit when a mysterious woman asks for his help in finding a valuable statuette. 'The Maltese Falcon' is a classic crime novel that set the standard for noir fiction.", null, null, Date.valueOf("1930-02-14"), new BigDecimal("2.0"), 1, 0, new HashSet<>(Collections.singletonList(categories.get(3)))),
                new Audiobook(null, "Aesop's Fables", "Aesop", "A timeless collection of fables, attributed to the ancient Greek storyteller Aesop. These short tales feature animals with human-like qualities and convey moral lessons. 'Aesop's Fables' has been cherished for centuries for its wisdom and simplicity.", null, null, Date.valueOf("0001-11-11"), new BigDecimal("1.0"), 2, 0, new HashSet<>(Collections.singletonList(categories.get(4)))),
                new Audiobook(null, "Pride and Prejudice", "Jane Austen", "Jane Austen's classic 'Pride and Prejudice' explores the complex dynamics of love and social class in 19th-century England. The headstrong Elizabeth Bennet navigates societal expectations and misconceptions on her journey to find true love.", null, null, Date.valueOf("1813-01-28"), new BigDecimal("4.5"), 10, 0, new HashSet<>(Collections.singletonList(categories.get(1)))),
                new Audiobook(null, "Brave New World", "Aldous Huxley", "A dystopian classic, 'Brave New World' envisions a future where society is controlled through genetic engineering and psychological conditioning. Huxley explores themes of individuality, freedom, and the consequences of a utopian vision gone wrong.", null, null, Date.valueOf("1932-06-14"), new BigDecimal("2.3"), 20, 0, new HashSet<>(Collections.singletonList(categories.get(2)))),
